                    ...
                    [FromBody] SignUpRequest patientDetails)
        {
            ...
            try
            {
                ...
                if (data.IsSuccess == true)
                {
                    ...
                    var status = await service.SendMessageAsync(patientDetails.MobileNo, $"Your Elite Hospital verification OTP code is {code} . Code vaid for 10 minutes only, one time use. Please DO NOT share this OTP with anyone.");
                ...
                else
                {
                    ...
                    response.Message = "Patient Validation Failed.";
                }
            }
            catch (Exception ex)
            {
